  ...
  // === Lesson 3.3: What's Your Name? ===
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        explanation:
          'おなまえは？ is a set phrase meaning "What is your name?" You\'ll hear this a lot in introductions.\n\nNotice there\'s no word for "you" — Japanese often skips it! The お at the start is an honorific prefix that signals you\'re asking about the other person\'s name, not your own. So なまえ = name, おなまえ = (your) name (polite). The は at the end is the same topic particle you just learned!\n\nTo answer, use the pattern you already know: わたしは [name] です. Easy!',
        examples: [
  ...
  // === Lesson 3.7: Unit 3 Quiz ===
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        type: 'multiple_choice',
        prompt: 'がくせいですか means:',
        options: ['Are you a student?', 'I am a student', 'I am not a student', 'The student is here'],
        correctIndex: 0,
      },
      {
        id: 'ex-3-7-04',
      ...
      },
      {
        ...
        type: 'translation',
        prompt: 'I came from America',
        correctAnswer: ['アメリカ', 'から', 'きました'],
        wordBank: ['アメリカ', 'から', 'きました', 'わたし', 'は', 'です'],
      },
      {
        id: 'ex-3-7-07',
        type: 'multiple_choice',
      ...
      },
      {
        id: 'ex-3-7-11',
        type: 'multiple_choice',
        prompt: 'にほんじんじゃないです means:',
        options: ['I am not Japanese', 'I am Japanese', 'Are you Japanese?', 'Japan is nice'],
        correctIndex: 0,
      },
      {
        id: 'ex-3-7-12',
      ...
      // Review Unit 2
      {
        id: 'ex-3-7-13',
        type: 'fill_blank',
        sentence: 'Someone helps you. You say: ＿',
        answer: 'ありがとうございます',
